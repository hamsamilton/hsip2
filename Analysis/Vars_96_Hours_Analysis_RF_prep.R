## Analysis
## Meg Hutch
## 03.07.2020 - 96 Hours - RF Data Prep
...
round(table(mcTrain$mortality)/78*100)
round(table(mcTest$mortality)/33*100)

# Sample size may be too small for it to be perfectly balanced

# save training and testing sets
write.csv(ds_no_temp, file = "C:/Users/User/Box Sync/Projects/Mimic_HSIP/To_Analyze/ds_no_temp.csv", row.names = FALSE)
write.csv(ds_full, file = "C:/Users/User/Box Sync/Projects/Mimic_HSIP/To_Analyze/ds_full.csv", row.names = FALSE)

write.csv(mcTrain, file = "C:/Users/User/Box Sync/Projects/Mimic_HSIP/To_Analyze/mcTrain_no_temp.csv", row.names = FALSE)
write.csv(mcTest, file = "C:/Users/User/Box Sync/Projects/Mimic_HSIP/To_Analyze/mcTest_no_temp.csv", row.names = FALSE)
